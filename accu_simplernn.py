...
def predict(file_path):
    ...
    # 저장된 모델 불러오기
    loaded_model = keras.models.load_model('joint_angle_classification_model_simplernn.h5', compile=False)
...
# 여러 데이터 파일에 대해 실행
file_paths = [
    'hs_1_mediapipe_angle.csv',
    'hs_2_mediapipe_angle.csv',
    'hs_3_mediapipe_angle.csv',
    'hs_4_mediapipe_angle.csv',
    'hs_5_mediapipe_angle.csv',
    'hs_6_mediapipe_angle.csv',
    'hs_7_mediapipe_angle.csv',
    'hs_8_mediapipe_angle.csv',
    'hs_9_mediapipe_angle.csv',
    'hs_10_mediapipe_angle.csv',
    'js_1_mediapipe_angle.csv',
    'js_2_mediapipe_angle.csv',
    'js_3_mediapipe_angle.csv',
    'js_4_mediapipe_angle.csv',
    'js_5_mediapipe_angle.csv',
    'js_6_mediapipe_angle.csv',
    'js_7_mediapipe_angle.csv',
    'js_8_mediapipe_angle.csv',
    'js_9_mediapipe_angle.csv',
